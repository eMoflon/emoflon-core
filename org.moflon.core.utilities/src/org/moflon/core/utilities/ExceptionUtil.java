...
public final class ExceptionUtil
{
   ...
   /**
    * Throws a {@link CoreException} that contains an {@link IStatus} with the given message, plugin ID, and wrapped exception
    * @param message error message
    * @param plugin ID of throwing plugin
    * @param lowLevelException the optional wrapped exception (may be <code>null</code>).
