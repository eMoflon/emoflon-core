...
public final class ProgressMonitorUtil
{
   ...
   /**
    * Checks whether the given {@link IProgressMonitor} has been canceled and, if yes, throws an {@link OperationCanceledException} to indicate cancellation
    * @param monitor the monitor to be checked
    */
