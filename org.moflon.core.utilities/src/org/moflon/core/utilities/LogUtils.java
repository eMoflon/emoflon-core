 ...
 *
 * Its methods support format strings (see {@link String#format(String, Object...)}.
 *
...
public final class LogUtils
{
   ...
   /**
    * Basic logging helper method that logs a message (given as format string + optional arguments) using the given {@link Level}
    *
    * The method is built to be fail-safe, i.e. no exceptions will be thrown if the given format string is invalid.
    * Instead, an error message is printed to the logger.
    * If the logger is <code>null</code>, nothing happens.
    *
    * @param logger the logger to log to
    * @param t the exception to log
    * @param formatString the format string of the message
    * @param arguments the (optional) arguments of the format string of the message
    */
   public static void log(final Logger logger, final Level level, final String formatString, final Object... arguments)
   {
      if (logger == null)
         return;
   ...
   /**
    * This method logs (i) a message (given as format string + optional arguments) and (ii) the stacktrace of the given {@link Throwable} as {@link Level#ERROR}.
    *
    * @param logger the logger to log to
    * @param formatString the format string of the message
    * @param arguments the (optional) arguments of the format string of the message
   ...
   /**
    * This method solely logs the stacktrace of the given {@link Throwable} as{@link Level#ERROR}.
    *
   ...
   /**
    * This method logs (i) a message (given as format string + optional arguments) and (ii) the stacktrace of the given {@link Throwable} as {@link Level#WARN}.
    *
    * @param logger the logger to log to
    * @param formatString the format string of the message
    * @param arguments the (optional) arguments of the format string of the message
   ...
   /**
    * This method logs (i) a message (given as format string + optional arguments) and (ii) the stacktrace of the given {@link Throwable} as {@link Level#INFO}.
    *
    * @param logger the logger to log to
    * @param formatString the format string of the message
    * @param arguments the (optional) arguments of the format string of the message
   ...
   /**
    * This method logs (i) a message (given as format string + optional arguments) and (ii) the stacktrace of the given {@link Throwable} as {@link Level#DEBUG}.
    *
    * @param logger the logger to log to
    * @param formatString the format string of the message
    * @param arguments the (optional) arguments of the format string of the message
   ...
   private static String formatStringFailsafe(final String formatString, final Object... arguments)
   {
      ...
      } catch (final IllegalFormatException e)
      {
         ...
         str = String.format("ERROR: Malformed format string for error message: formatString='%s', parameters='%s'", formatString, Arrays.deepToString(arguments));
      }
      return str;
   }
}
