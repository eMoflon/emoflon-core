...
public class MoflonConventions
{
   ...
   */
   ...
   /**
    * Returns the default name of the eMoflon-related files in a project.
    * By convention, the result is equal to the last segment (.-separated) with the first letter capitalized.
   ...
   /**
    * The default path is /model/[{@link #getDefaultNameOfFileInProjectWithoutExtension(String)}][suffix]
    * @param projectName the project name
   ...
   /**
    * Equivalent to {@link #getDefaultPathToFileInProject(String, String)} with .genmodel suffix
    * @param projectName the project name
   ...
   /**
    * Equivalent to {@link #getDefaultPathToFileInProject(String, String)} with .ecore suffix
    * @param projectName the project name
   ...
   /**
    * Returns the project-relative URI corresponding to {@link #getDefaultPathToEcoreFileInProject(String)}
   ...
   /**
    * Returns a handle to the default location of a Ecore file of an eMoflon project
    *
    * @param project
