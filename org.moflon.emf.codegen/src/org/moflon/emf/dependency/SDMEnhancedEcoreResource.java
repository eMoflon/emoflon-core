...
public class SDMEnhancedEcoreResource extends XMIResourceImpl {
    ...
    * <em>EModelElements</em>} of this <code>ECoreResource</code>
    * via the <b>generated</b> {@link org.eclipse.emf.ecore.EPackage#getNsURI()
    * namespace URIs</em>}
   ...
   public final void setHandleGeneratedEPackageURIs(
         boolean handleGeneratedEPackageURIs) {
   ...
   public final void setUseGeneratedEPackageResource(
         boolean useGeneratedEPackageResource) {
   ...
   protected XMLSave createXMLSave(Map<?, ?> options) {
      if (options != null) {
         ...
         overrideHelper = optionValue instanceof Boolean ?
   ...
   protected XMLHelper createXMLHelper() {
      return overrideHelper ?
            new SDMEnhancedResourceHelper(this) :
            super.createXMLHelper();
   }

   public void save(Map<?, ?> options) throws IOException {
	   Object readOnlyOption = options != null && options.containsKey(READ_ONLY) ? options.get(READ_ONLY) : defaultSaveOptions != null ? defaultSaveOptions.get(READ_ONLY) : null;
