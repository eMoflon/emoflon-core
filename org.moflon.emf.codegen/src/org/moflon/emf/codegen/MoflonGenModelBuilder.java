...
public class MoflonGenModelBuilder extends GenModelBuilder
{
   ...
   public MoflonGenModelBuilder(final ResourceSet resourceSet, final List<Resource> resources, final IFile ecoreFile, final String basePackage,
         final String modelDirectory, final MoflonPropertiesContainer moflonProperties)
   {
      super(resourceSet);
   ...
   /**
    * Returns a platform:/ {@link URI} for the given project based on the corresponding preferences in {@link EMoflonPreferencesStorage}
   ...
   private final URI lookupExtensionRegistry(final URI uri)
   {
      ...
      final IExtensionPoint extensionPoint = Platform.getExtensionRegistry().getExtensionPoint("org.eclipse.emf.ecore.generated_package");
