 ...
 *
 */
public abstract class AbstractMoflonClassGeneratorAdapter extends org.eclipse.emf.codegen.ecore.genmodel.generator.GenClassGeneratorAdapter
{
   ...
   public String getInjectedCode(final boolean isImplementation)
   {
      ...
      if (injectionManager != null)
      {
         ...
         final String fullyQualifiedClassName = isImplementation ? InjectionUtilities.getClassName(genClass) : InjectionUtilities.getInterfaceName(genClass);
