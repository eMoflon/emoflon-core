...
import org.moflon.emf.resource.GenModelResource;
import org.moflon.emf.resource.GenModelResourceFactory;
...
public class GenModelBuilder {
   ...
   public void loadDefaultSettings() {
	   ...
	   resourceSet.getResourceFactoryRegistry().getExtensionToFactoryMap().put(GENMODEL_FILE_EXTENSION, new GenModelResourceFactory());
