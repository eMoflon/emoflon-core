		...
		public class «e_pak.get_emf_e_package.name.toFirstUpper»PackageImpl extends EPackageImpl
			...
			public void initializePackageContents() {
				...
				initEReference(get«clazz.name»_«ref.name.toFirstUpper»(), this.get«ref.EType.name.toFirstUpper»(), «IF ref.EOpposite !== null»this.get«ref.EType.name.toFirstUpper»_«ref.EOpposite.name.toFirstUpper»(),«ELSE» null,«ENDIF» 
					"«ref.name»", «(ref.defaultValue === null)?"null":ref.defaultValue», «ref.lowerBound», «ref.upperBound», «clazz.name».class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				...
				initEAttribute(get«clazz.name»_«atr.name.toFirstUpper»(), «IF atr.EType.EPackage.name.equals("ecore")»ecorePackage.get«atr.EType.name»()«ELSE»«atr.EType.EPackage.name.toFirstUpper»Package.eINSTANCE.get«atr.EType.name.toFirstUpper»()«ENDIF»,
					"«atr.name»", «(atr.defaultValue === null)?"null":"\""+atr.defaultValue+"\""», «atr.lowerBound», «atr.upperBound», «clazz.name».class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
									!IS_ORDERED);
				«ENDIF»
				«ENDFOR»
