package org.moflon.core.plugins.test;
...
public class ManifestFileUpdaterTest
{
   ...
   {
      List<String> missingDependencies = ManifestFileUpdater.calculateMissingDependencies(Arrays.asList("org.A"), Arrays.asList("org.B"));
   ...
   {
      List<String> missingDependencies = ManifestFileUpdater.calculateMissingDependencies(Arrays.asList("org.A", "org.B"), Arrays.asList("org.B"));
   ...
   {
      List<String> missingDependencies = ManifestFileUpdater.calculateMissingDependencies(Arrays.asList("org.A", "org.B;bundle-version=\"3.7.0\""),
            Arrays.asList("org.B"));
      Assert.assertEquals(Arrays.asList(), missingDependencies);
   }
   ...
   @Test
   public void testCalculateMissingDependencies6__IgnoreNewDependencyWithSamePluginIdButDifferentVersion() throws Exception
   {
      List<String> missingDependencies = ManifestFileUpdater.calculateMissingDependencies(Arrays.asList("org.A", "org.B;bundle-version=\"3.7.0\""),
