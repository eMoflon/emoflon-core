...
public class InjectionManagerTest {
	...
	private static final List<String> IMPORTS_FOR_CLASS_1 = Arrays.asList("import.for.class.1.1",
			"import.for.class.1.2");
	...
	public void testThatCodeInjectionFailsWithoutAGivenCodeInjector() throws Exception {
		final InjectionManager injectionManager = new InjectionManager(defaultInjectionExtractor,
				defaultInjectionExtractor, new UnsupportedOperationCodeInjector());
	...
	public void testThatDummyInjectionExtractorReturnsMemberProperly() throws Exception {
		final InjectionManager injection = new InjectionManager(defaultInjectionExtractor, defaultInjectionExtractor,
				new UnsupportedOperationCodeInjector());
	...
	class UnsupportedOperationCodeInjector implements CodeInjector {
		...
		private void fail() {
			throw new UnsupportedOperationException(
					"This code injector serves as a placeholder and cannot inject code.");
		}
