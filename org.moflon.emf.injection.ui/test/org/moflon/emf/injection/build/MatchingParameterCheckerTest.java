...
public class MatchingParameterCheckerTest {
	...
	private void shouldMatch(final EOperation operation, final List<String> parameterNames,
			final List<String> parameterTypes) {
		Assert.assertTrue(parameterChecker.haveMatchingParamters(operation, parameterTypes));
	}

	private void shouldNotMatch(final EOperation operation, final List<String> parameterNames,
			final List<String> parameterTypes) {
