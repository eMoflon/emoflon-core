 ...
 *  The converter prepends a given source folder (e.g., 'gen', 'src') to the generated relative path.
 */
public class ClassNameToPathConverter
{
   ...
   /**
    * Creates a converter with the system file separator (java.io.File.fileSeparator) and the given source root folder ('src', 'gen', ...).
    * @param sourceFolder
    */
   ...
   /**
    * Creates a converter with the provided file separator and the given source root folder ('src', 'gen', ...).
    * @param sourceFolder
    * @param fileSeparator
    */
