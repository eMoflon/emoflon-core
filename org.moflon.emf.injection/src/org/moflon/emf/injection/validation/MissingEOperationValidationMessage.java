...
public class MissingEOperationValidationMessage extends InjectionValidationMessage
{
   ...
   public MissingEOperationValidationMessage(final String methodName, final List<String> paramTypes, final String className,
         final String fileName)
   {
      super("Cannot find the EOperation " + getMethodSignature(methodName, paramTypes) + " in class '" + className + "'.", fileName,
            IStatus.WARNING);
   }
