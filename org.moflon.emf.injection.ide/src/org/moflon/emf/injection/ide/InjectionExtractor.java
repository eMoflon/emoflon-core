...
public interface InjectionExtractor
{
   ...
   /**
    * Retrieves the classes imported by the class with the given fullyQualifiedName. These are just the 
    * raw imports without the keyword 'import' or semicolons.
    * 
    * @param fullyQualifiedName
    *           Fully qualified name of the class into which imported classes are injected.
    ...
    * 
    * @param fullyQualifiedName
    *           Fully qualified name of the class into which the members code is injected.<br>
