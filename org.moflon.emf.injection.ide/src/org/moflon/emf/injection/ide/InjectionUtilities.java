...
public final class InjectionUtilities {
   ...
   /**
    * Returns the fully-qualified name of the interface class belonging to the given {@link GenClass}
    * @param genClass the {@link GenClass}
   ...
   /**
    * Returns the fully-qualified name of the implementation class belonging to the given {@link GenClass}
    * @param genClass the {@link GenClass}
    * @return the fully-qualified name
    */
