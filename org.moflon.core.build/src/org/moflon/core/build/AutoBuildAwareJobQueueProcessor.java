...
public final class AutoBuildAwareJobQueueProcessor extends JobChangeAdapter
{
    ...
    * @throws CoreException if processing failed
    */
   ...
   public void done(final IJobChangeEvent event)
   {
      ...
      if (!result.isOK())
      {
         LogUtils.info(logger, "Job %s exited with non-OK status %s", event.getJob(), WorkspaceHelper.getSeverityAsString(result));
