...
import org.moflon.codegen.MoflonGenModelBuilder;
...
public final class MonitoredGenModelBuilder implements ITask
{
   ...
   public final IStatus run(final IProgressMonitor monitor)
   {
      ...
      IStatus resourceSetStatus = eMoflonEMFUtil.validateResourceSet(resourceSet, "GenModel building", subMon.split(10));
      if (subMon.isCanceled())
      {
         return Status.CANCEL_STATUS;
      }
