...
public final class WorkingSetUtilities
{
   ...
   /**
    * Returns the set of selected working set of the given {@link IStructuredSelection}
    *
   ...
   public static IWorkingSet[] getSelectedWorkingSet(IStructuredSelection selection, IWorkbenchPart activePart)
   {
      ...
      if (explorerPart.getRootMode() == org.eclipse.jdt.internal.ui.packageview.PackageExplorerPart.PROJECTS_AS_ROOTS)
      {
         //Get active filter
