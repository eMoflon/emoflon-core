...
/**
 * This tester evaluates whether the currently active perspective is the expected one.
 * 
 * It replaces the formerly built-in method of querying the _activeWindow.activePerspective_ property.
 * 
 * Original source: http://jonathanjwright.wordpress.com/2014/07/15/eclipse-4-4-0-perspective-based-show-hide-of-tool-bar-items/
 *
 */
