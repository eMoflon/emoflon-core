...
public class UiUtilities
{
    ...
    * @throws CoreException
    */
   public static void openWizard(final String wizardId, final IWorkbenchWindow window, final IStructuredSelection selection) throws CoreException
   {
      // Search for wizard
      final IWorkbenchWizard wizard = window.getWorkbench().getNewWizardRegistry().findWizard(wizardId).createWizard();
   ...
   /**
    * Returns an {@link ImageDescriptor} for an icon located at the given relative path within the given plugin
    * @param pluginId the plugin ID
    * @param pluginRelativePathToIcon the plugin-relative path to the icon
