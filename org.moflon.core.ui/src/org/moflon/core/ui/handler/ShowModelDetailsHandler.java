 ...
 *
 */
public class ShowModelDetailsHandler extends AbstractCommandHandler {

	private static final Logger logger = LogManager.getLogger(ShowModelDetailsHandler.class);
	
	public ShowModelDetailsHandler() {
		super();
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Configurator.getInstance().setDiagramStyle(EMoflonPlantUMLGenerator.SHOW_MODEL_DETAILS, toggleState);
