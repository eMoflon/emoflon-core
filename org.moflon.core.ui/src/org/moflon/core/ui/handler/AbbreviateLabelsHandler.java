 ...
 *
 */
public class AbbreviateLabelsHandler extends AbstractCommandHandler {
	
	private static final Logger logger = LogManager.getLogger(AbbreviateLabelsHandler.class);
	
	public AbbreviateLabelsHandler() {
		super();
	}
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		Configurator.getInstance().setDiagramStyle(EMoflonPlantUMLGenerator.ABBR_LABELS, toggleState);
