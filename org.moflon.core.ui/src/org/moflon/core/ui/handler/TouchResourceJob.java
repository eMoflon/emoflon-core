...
/**
 * This job touches a set of {@link IResource}s during {@link #runInWorkspace(IProgressMonitor)}.
 *
...
public class TouchResourceJob extends WorkspaceJob
{
   ...
   public IStatus runInWorkspace(final IProgressMonitor monitor)
   {
      ...
      final MultiStatus status = new MultiStatus(WorkspaceHelper.getPluginId(getClass()), 0, "Problems while touching resources", null);
