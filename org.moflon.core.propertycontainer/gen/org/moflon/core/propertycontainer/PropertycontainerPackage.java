...
public interface PropertycontainerPackage extends EPackage
{
   ...
   /**
    * The operation id for the '<em>Update Metamodel Project Name</em>' operation.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int MOFLON_PROPERTIES_CONTAINER___UPDATE_METAMODEL_PROJECT_NAME__STRING = 0;

   /**
    * The operation id for the '<em>Check For Missing Defaults</em>' operation.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @generated
    * @ordered
    */
   int MOFLON_PROPERTIES_CONTAINER___CHECK_FOR_MISSING_DEFAULTS = 1;
    ...
    * @ordered
    */
   int MOFLON_PROPERTIES_CONTAINER_OPERATION_COUNT = 2;
   ...
   /**
    * Returns the meta object for the '{@link org.moflon.core.propertycontainer.MoflonPropertiesContainer#updateMetamodelProjectName(java.lang.String) <em>Update Metamodel Project Name</em>}' operation.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the '<em>Update Metamodel Project Name</em>' operation.
    * @see org.moflon.core.propertycontainer.MoflonPropertiesContainer#updateMetamodelProjectName(java.lang.String)
    * @generated
    */
   EOperation getMoflonPropertiesContainer__UpdateMetamodelProjectName__String();

   /**
    * Returns the meta object for the '{@link org.moflon.core.propertycontainer.MoflonPropertiesContainer#checkForMissingDefaults() <em>Check For Missing Defaults</em>}' operation.
    * <!-- begin-user-doc -->
    * <!-- end-user-doc -->
    * @return the meta object for the '<em>Check For Missing Defaults</em>' operation.
    * @see org.moflon.core.propertycontainer.MoflonPropertiesContainer#checkForMissingDefaults()
    * @generated
    */
   EOperation getMoflonPropertiesContainer__CheckForMissingDefaults();
   ...
   interface Literals
   {
       ...
       * @generated
       */
      EAttribute SDM_CODEGENERATOR_METHOD_BODY_HANDLER__DESCRIPTION = eINSTANCE.getSdmCodegeneratorMethodBodyHandler_Description();
       ...
       * @generated
       */
      EAttribute SDM_CODEGENERATOR_METHOD_BODY_HANDLER__VALUE = eINSTANCE.getSdmCodegeneratorMethodBodyHandler_Value();
       ...
       * @generated
       */
      EReference MOFLON_PROPERTIES_CONTAINER__SDM_CODEGENERATOR_HANDLER_ID = eINSTANCE.getMoflonPropertiesContainer_SdmCodegeneratorHandlerId();
      ...
      /**
       * The meta object literal for the '<em><b>Update Metamodel Project Name</b></em>' operation.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EOperation MOFLON_PROPERTIES_CONTAINER___UPDATE_METAMODEL_PROJECT_NAME__STRING = eINSTANCE
            .getMoflonPropertiesContainer__UpdateMetamodelProjectName__String();

      /**
       * The meta object literal for the '<em><b>Check For Missing Defaults</b></em>' operation.
       * <!-- begin-user-doc -->
       * <!-- end-user-doc -->
       * @generated
       */
      EOperation MOFLON_PROPERTIES_CONTAINER___CHECK_FOR_MISSING_DEFAULTS = eINSTANCE.getMoflonPropertiesContainer__CheckForMissingDefaults();
