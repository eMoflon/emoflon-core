...
public class PropertycontainerAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * <em>Dependencies</em>}'. <!-- begin-user-doc --> This default implementation
	 ...
	 * <em>Additional Used Gen Packages</em>}'. <!-- begin-user-doc --> This default
	 ...
	 * Mappings</em>}'. <!-- begin-user-doc --> This default implementation returns
	 * null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	 ...
	 * Mode</em>}'. <!-- begin-user-doc --> This default implementation returns null
	 ...
	 * <em>Moflon Properties Container</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 ...
	 * <em>Additional Dependencies</em>}'. <!-- begin-user-doc --> This default
	 * implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 ...
	 * Project</em>}'. <!-- begin-user-doc --> This default implementation returns
	 * null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
