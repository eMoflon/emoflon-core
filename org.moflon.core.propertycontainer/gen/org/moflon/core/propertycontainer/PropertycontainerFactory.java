...
public interface PropertycontainerFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Dependencies</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Import Mappings</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>TGG Build Mode</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Sdm Codegenerator Method Body
	 * Handler</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return a new object of class '<em>Sdm Codegenerator Method Body
	 *         Handler</em>'.
	 * @generated
	 */
