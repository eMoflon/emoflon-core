...
public class PropertycontainerPackageImpl extends EPackageImpl implements PropertycontainerPackage
{
    ...
    * @generated
    */
   public EOperation getMoflonPropertiesContainer__UpdateMetamodelProjectName__String()
   {
      return moflonPropertiesContainerEClass.getEOperations().get(0);
   }
    ...
    * @generated
    */
   public EOperation getMoflonPropertiesContainer__CheckForMissingDefaults()
   {
      return moflonPropertiesContainerEClass.getEOperations().get(1);
   }
   ...
   public void createPackageContents()
   {
      ...
      createEOperation(moflonPropertiesContainerEClass, MOFLON_PROPERTIES_CONTAINER___UPDATE_METAMODEL_PROJECT_NAME__STRING);
      createEOperation(moflonPropertiesContainerEClass, MOFLON_PROPERTIES_CONTAINER___CHECK_FOR_MISSING_DEFAULTS);
   ...
   public void initializePackageContents()
   {
      ...
      EOperation op = initEOperation(getMoflonPropertiesContainer__UpdateMetamodelProjectName__String(), null, "updateMetamodelProjectName", 0, 1, IS_UNIQUE,
            IS_ORDERED);
      addEParameter(op, ecorePackage.getEString(), "metamodelProjectName", 0, 1, IS_UNIQUE, IS_ORDERED);

      initEOperation(getMoflonPropertiesContainer__CheckForMissingDefaults(), null, "checkForMissingDefaults", 0, 1, IS_UNIQUE, IS_ORDERED);
