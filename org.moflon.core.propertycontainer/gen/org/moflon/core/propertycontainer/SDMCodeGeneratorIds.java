...
public enum SDMCodeGeneratorIds implements Enumerator {
    ...
    * @ordered
    */
   DEMOCLES_ATTRIBUTES(2, "DEMOCLES_ATTRIBUTES", "org.moflon.compiler.sdm.democles.attributes.AttributeConstraintCodeGeneratorConfig"),
    ...
    * @ordered
    */
   DEMOCLES_REVERSE_NAVI(3, "DEMOCLES_REVERSE_NAVI", "org.moflon.compiler.sdm.democles.reversenavigation.ReverseNavigationCodeGeneratorConfig");
    ...
    * @generated
    */
   private static final SDMCodeGeneratorIds[] VALUES_ARRAY = new SDMCodeGeneratorIds[] { DEMOCLES, DEMOCLES_ATTRIBUTES, DEMOCLES_REVERSE_NAVI, };
