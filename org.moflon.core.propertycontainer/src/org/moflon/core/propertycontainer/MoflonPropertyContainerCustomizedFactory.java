 ...
 * MoflonPropertyContainer to support the proper handling of method body
 * handlers.
 */
public class MoflonPropertyContainerCustomizedFactory extends PropertycontainerFactoryImpl {

	@Override
	public SDMCodeGeneratorIds createSDMCodeGeneratorIdsFromString(final EDataType eDataType,
